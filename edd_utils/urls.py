...
urlpatterns = [
    ...
    path('cytometry/parse/', login_required(views.cytometry_parse), name="cytometry_parse"),
    path('cytometry/import/', login_required(views.cytometry_import), name="cytometry_import"),
]
