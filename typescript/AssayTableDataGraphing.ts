...
//			" Maxedge: " + maxEdge);
		...
		if (stepSize < 1) { // Step size of less than one would not advance through the array at all!
			stepSize = 1;
		}
...
//				console.log("v: " + v + " i: " + i + " sScale: " + sScale);				
			} while (sScale > 0.4);
    ...
    showTooltip:function(x, y, contents, col) {
        var newTip:any = $('<div id="tooltip" class="graphToolTip">' + contents + '</div>');
