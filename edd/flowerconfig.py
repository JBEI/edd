...
# of Flower 0.9, also requiring the password as part of the URL (a security flaw).
#
# Note that errors in testing variations on broker_url input are only visible in Flower logs when a user has accessed
# Flower's "Broker" tab. Cryptic error messages mention "Failed management API call".
