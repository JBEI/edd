...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tags",
                    fields.ArrayField(
                        base_field=main.models.fields.VarCharField(),
                        default=[],
        ...
        migrations.AlterUniqueTogether(
            name="metadatatype", unique_together=set([("type_name", "for_context")])
        ),
        migrations.AddField(
            model_name="metabolitespecies",
            name="sbml_template",
        ...
        migrations.AlterUniqueTogether(
            name="metabolitespecies",
            unique_together=set(
                [("sbml_template", "species"), ("sbml_template", "measurement_type")]
            ),
        ),
        migrations.AlterIndexTogether(
            name="metabolitespecies", index_together=set([("sbml_template", "species")])
        ),
        migrations.AlterUniqueTogether(
            name="metaboliteexchange",
            unique_together=set(
        ...
        migrations.AlterIndexTogether(
            name="metaboliteexchange",
            index_together=set(
                [("sbml_template", "exchange_name"), ("sbml_template", "reactant_name")]
            ),
        ),
