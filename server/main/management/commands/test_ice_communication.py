...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "username",
            help="The username of the ICE user whose credentials "
            "will be used to access the system",
        )
        parser.add_argument(
            "--part_id",
            help="The optional part id, local primary key, "
        ...
        parser.add_argument(
            "--term",
            help="A search term to use in searching ICE. "
            "Ignored if --part_id is provided.",
            default="",
        )
