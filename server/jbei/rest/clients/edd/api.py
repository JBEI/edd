...
from .constants import (
    ...
    EXPERIMENTERS_REQUEST_PARAM,
    LINES_REQUEST_PARAM,
    MEAS_TYPE_NAME_REGEX,
    MEAS_TYPES_PARAM,
    MEASUREMENT_PKS_PARAM,
    METADATA_CONTEXT_VALUES,
    METADATA_TYPE_CONTEXT_PARAM,
    METADATA_TYPE_GROUP_PARAM,
    METADATA_TYPE_I18N,
    NAME_REGEX_PARAM,
    PAGE_NUMBER_URL_PARAM,
    PAGE_SIZE_QUERY_PARAM,
    PROTOCOLS_REQUEST_PARAM,
    TYPE_GROUP_PARAM,
...
class DrfSession(PagedSession):
    ...
    def __init__(
        ...
        super(DrfSession, self).__init__(
            result_limit_param_name=result_limit_param_name,
...
class EddApi(RestApiClient):
    ...
    def __init__(self, auth, base_url, result_limit=DEFAULT_PAGE_SIZE, verify=True):
        ...
        """
        session = DrfSession(
            base_url, PAGE_SIZE_QUERY_PARAM, auth=auth, verify_ssl_cert=verify
        )
        if isinstance(auth, EddSessionAuth):
            auth.apply_session_token(session)
        super(EddApi, self).__init__(
            "EDD", base_url, session, result_limit=result_limit
        )

    @staticmethod
    def _add_eddobject_search_params(search_params, **kwargs):
        _set_if_value_valid(
            search_params, NAME_REGEX_PARAM, kwargs.pop("name_regex", None)
        )
        _set_if_value_valid(
            search_params, DESCRIPTION_REGEX_PARAM, kwargs.pop("description", None)
        )
        _set_if_value_valid(
            search_params, CREATED_AFTER_PARAM, kwargs.pop("created_after", None)
        )
        _set_if_value_valid(
            search_params, CREATED_BEFORE_PARAM, kwargs.pop("created_before", None)
        )
        _set_if_value_valid(
            search_params, UPDATED_AFTER_PARAM, kwargs.pop("updated_after", None)
        )
        _set_if_value_valid(
            search_params, UPDATED_BEFORE_PARAM, kwargs.pop("updated_before", None)
        )
    ...
    def search_measurement_units(self, **kwargs):
        ...
        if query_url:
            ...
            response = self.session.get(
                url, params=search_params, headers=self._json_header
            )
    ...
    def search_measurement_types(self, **kwargs):
        ...
        if query_url:
            ...
            search_params = {}
            _set_if_value_valid(
                search_params, MEAS_TYPE_NAME_REGEX, kwargs.pop("type_name_regex", None)
            )
            _set_if_value_valid(
                search_params, TYPE_GROUP_PARAM, kwargs.pop("type_group", None)
            )
            _set_if_value_valid(
                search_params,
                PAGE_NUMBER_URL_PARAM,
    ...
    def search_measurements(self, **kwargs):
        ...
        if query_url:
            ...
            search_params = {}
            _set_multivalue_pk_input(
                search_params, ASSAYS_PARAM, kwargs.pop("assays", None)
            )
            _set_multivalue_pk_input(
                search_params, MEAS_TYPES_PARAM, kwargs.pop("measurement_types", None)
            )
            _set_multivalue_pk_input(
                search_params, "x_units__in", kwargs.pop("x_units", None)
            )
            _set_multivalue_pk_input(
                search_params, "y_units__in", kwargs.pop("y_units", None)
            )
            _set_if_value_valid(
                search_params, COMPARTMENT_PARAM, kwargs.pop("compartment", None)
            )
            _set_if_value_valid(
                search_params, CREATED_AFTER_PARAM, kwargs.pop("created_after", None)
            )
    ...
    def search_values(self, **kwargs):
        ...
        if query_url:
            ...
            search_params = {}
            _set_multivalue_pk_input(
                search_params, MEASUREMENT_PKS_PARAM, kwargs.pop("measurements", None)
            )
            _set_if_value_valid(
                search_params,
                PAGE_NUMBER_URL_PARAM,
    ...
    def search_metadata_types(self, **kwargs):
        ...
        if query_url:
            ...
            _set_if_value_valid(
                search_params, METADATA_TYPE_GROUP_PARAM, kwargs.get("group", None)
            )
            _set_if_value_valid(
                search_params, METADATA_TYPE_I18N, kwargs.pop("type_i18n", None)
            )
    ...
    def _get_single_object(self, unique_id, url_pattern, result_class):
        url = url_pattern % {"base": self.base_url, "id": unique_id}
    ...
    def search_protocols(self, **kwargs):
        ...
        if query_url:
            ...
            unprocessed_kwargs = self._add_eddobject_search_params(
    ...
    def search_studies(self, **kwargs):
        ...
        if query_url:
            ...
            search_params = {}
            _set_if_value_valid(
                search_params, PAGE_NUMBER_URL_PARAM, kwargs.pop("page_number", None)
            )
    ...
    def search_lines(self, **kwargs):
        ...
        if query_url:
            ...
            search_params = {}
            _set_multivalue_pk_input(
                search_params, "strains__in", kwargs.pop("strains", None)
            )
            _set_if_value_valid(
                search_params,
                PAGE_NUMBER_URL_PARAM,
    ...
    def search_assays(self, **kwargs):
        ...
        if query_url:
            ...
            search_params = {}
            _set_multivalue_pk_input(
                search_params, PROTOCOLS_REQUEST_PARAM, kwargs.pop("protocols", None)
            )
            _set_multivalue_pk_input(
                search_params, LINES_REQUEST_PARAM, kwargs.pop("lines", None)
            )
            _set_multivalue_pk_input(
                search_params,
                EXPERIMENTERS_REQUEST_PARAM,
...
class DrfPagedResult(PagedResult):
    def __init__(self, results, total_result_count, next_page=None, previous_page=None):
        super(DrfPagedResult, self).__init__(
            results, total_result_count, next_page, previous_page
        )
