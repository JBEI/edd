...
parse_code_to_ui_detail = {
    ...
    FileParseCodes.DUPLICATE_DATA_ENTRY: {"category": _(""), "summary": _("")},
}
...
processing_code_to_ui_detail = {
    ...
    FileProcessingCodes.MERGE_NOT_SUPPORTED: {
        ...
        "summary": _(
            "Your study already contains data for this protocol.  Merge with existing "
...
def get_ui_summary(err_type):
    ...
    src_dict = (
        parse_code_to_ui_detail
        if isinstance(err_type, FileParseCodes)
        else processing_code_to_ui_detail
    )
