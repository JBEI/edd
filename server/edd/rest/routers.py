...
base_rest_api_router.register(
    constants.ASSAYS_RESOURCE_NAME, views.AssaysViewSet, base_name="assays"
)
base_rest_api_router.register(
    constants.LINES_RESOURCE_NAME, views.LinesViewSet, base_name="lines"
)
base_rest_api_router.register(
...
base_rest_api_router.register(
    constants.VALUES_RESOURCE_NAME, views.MeasurementValuesViewSet, base_name="values"
)
base_rest_api_router.register(
    constants.STUDIES_RESOURCE_NAME, views.StudiesViewSet, base_name="studies"
)
base_rest_api_router.register(
...
base_rest_api_router.register(
    constants.METADATA_GROUPS_RESOURCE_NAME, views.MetadataGroupViewSet
)
base_rest_api_router.register(constants.PROTOCOLS_RESOURCE_NAME, views.ProtocolViewSet)
base_rest_api_router.register(
...
base_rest_api_router.register(
    constants.USERS_RESOURCE_NAME, views.UsersViewSet, base_name="users"
)
...
study_router = nested_routers.NestedSimpleRouter(
    base_rest_api_router, constants.STUDIES_RESOURCE_NAME, lookup="study"
)
study_router.register(
    constants.LINES_RESOURCE_NAME, views.StudyLinesView, base_name="study-lines"
)
study_router.register(
    constants.ASSAYS_RESOURCE_NAME, views.StudyAssaysViewSet, base_name="study-assays"
)
study_router.register(
    constants.MEASUREMENTS_RESOURCE_NAME,
...
study_router.register(
    constants.VALUES_RESOURCE_NAME, views.StudyValuesViewSet, base_name="study-values"
)
