...
SCHEMA = {
    ...
    "properties": {
        ...
        "name_elements": {
            "type": "object",
            "properties": {
                "elements": {"type": "array", "items": {"type": ["number", "string"]}},
        ...
        "common_line_metadata": {
            "type": "object",
            "additionalProperties": {"type": ["array", "string", "number", "boolean"]},
        },
        "combinatorial_line_metadata": {
            "type": "object",
            "additionalProperties": {
                "type": "array",
                "items": {"type": ["array", "number", "string", "boolean"]},
            },
        },
        "custom_name_elts": {"type": "object"},
        ...
        "email_when_finished": {"type": "boolean"},
    },
