...
CELERY_TASK_QUEUES = (
    ...
    Queue("edd.load.tasks.import_table_task"),
    Queue("edd.load.tasks.send_import_completion_email"),
    Queue("edd.load.tasks.send_import_failure_email_admins"),
    Queue("edd.load.tasks.send_import_failure_email"),
