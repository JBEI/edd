...
EDDATD = {
    ...
    processImportSettings: function () {
        var mainRadioM = document.getElementById("mlayout");
        var mainRadioT = document.getElementById("tlayout");
        var mainRadioP = document.getElementById("playout");
        var mainRadioD = document.getElementById("dlayout");
        ...
        if (EDDATD.interpretationMode == "metaboliteData") {
            if (EDDATD.StartData.Metabolites.sets.length > 0) {
                ...
                for (var x = 0; x < EDDATD.StartData.Metabolites.allALabels.length; x++) {
                    ...
                    for (var y = 0; y < EDDATD.StartData.Metabolites.allTimestamps.length; y++) {
                        textBoxContent += "\t" + EDDATD.StartData.Metabolites.tempGraphData[x][y];
                    }
                    if (x < (EDDATD.StartData.Metabolites.allALabels.length - 1)) {
                        textBoxContent += "\n";
                    }
                }
            }
            ...
            if (EDDATD.StartData.Transcriptions.sets.length > 0) {
                ...
                for (var x = 0; x < EDDATD.StartData.Transcriptions.allALabels.length; x++) {
                    textBoxContent += EDDATD.StartData.Transcriptions.allALabels[x] + "\t";
                    textBoxContent += EDDATD.StartData.Transcriptions.allMLabels[x];
                    for (var y = 0; y < EDDATD.StartData.Transcriptions.allTimestamps.length; y++) {
                        textBoxContent += "\t" + EDDATD.StartData.Transcriptions.tempGraphData[x][y];
                    }
                    if (x < (EDDATD.StartData.Transcriptions.allALabels.length - 1)) {
                        textBoxContent += "\n";
                    }
                }
            }
            ...
            if (EDDATD.StartData.Proteins.sets.length > 0) {
                ...
                for (var x = 0; x < EDDATD.StartData.Proteins.allALabels.length; x++) {
                    textBoxContent += EDDATD.StartData.Proteins.allALabels[x] + "\t";
                    textBoxContent += EDDATD.StartData.Proteins.allMLabels[x];
                    for (var y = 0; y < EDDATD.StartData.Proteins.allTimestamps.length; y++) {
                        textBoxContent += "\t" + EDDATD.StartData.Proteins.tempGraphData[x][y];
                    }
                    if (x < (EDDATD.StartData.Proteins.allALabels.length - 1)) {
                        textBoxContent += "\n";
                    }
                }
            }
            ...
            for (var key in ATData.startMetaData) {
                var onePair = ATData.startMetaData[key];
                var x = assayIndexes[onePair.aid];
            ...
            if (ATData.usedMetaDataTypes.length > 0) {
                ...
                for (var x = 0; x < ATData.selectedAssayIDs.length; x++) {
                    ...
                    if (x < (ATData.selectedAssayIDs.length - 1)) {
                        textBoxContent += "\n";
                    }
                }
            }
    ...
    parseAndDisplayText: function () {
        ...
        for (var i = 0; i < widestRow; i++) {
            ...
            if (((EDDATD.interpretationMode == "metaboliteData") && (i > 3)) || ((EDDATD.interpretationMode == "transcriptionData") && (i > 1)) || ((EDDATD.interpretationMode == "metaData") && (i > 0))) {
        ...
        for (var y = 0; y < rowCount; y++) {
            ...
            for (var x = 0; x < EDDATD.Grid.data[y].length; x++) {
                ...
                var shortVal = val;
                if (shortVal == '') {
                    shortVal = String.fromCharCode(0x00A0);
    ...
    toggleIgnoreGaps: function (box) {
        var tmpEl = document.getElementById("ignoreGaps");
        if (tmpEl.checked) {
    ...
    interpretDataTable: function () {
        ...
        for (var r = 0; r < EDDATD.Grid.l; r++) {
            ...
            for (var c = 0; c < EDDATD.Grid.w; c++) {
                ...
                // Timestamps
                if (((im == "metaboliteData") && (c > 3)) || ((im == "transcriptionData") && (c > 1))) {
                    n = n.replace(/,/g, '');
    ...
    remakeInfoTable: function () {
        ...
        if (EDDATD.Sets.uniqueAssayLineNames.length > 0) {
            ...
            for (var i = 0; i < EDDATD.Sets.uniqueAssayLineNames.length; i++) {
                var uName = EDDATD.Sets.uniqueAssayLineNames[i];
                ...
                if (!disamRow) {
                    ...
                    for (var ea in EDDData.EnabledAssayIDs) {
                        ...
                        var fullN = [ln, EDDData.Protocols[pid].name, EDDData.Assays[id].an].join('-');
        ...
        if ((EDDATD.Sets.uniqueMeasurementHashNames.length > 0) && (im != "transcriptionData")) {
            ...
            for (var i = 0; i < EDDATD.Sets.uniqueMeasurementHashNames.length; i++) {
                ...
                var uName = '' + umCompartment + ' ' + umType + ' ' + umUnits;
                // Find a pre-existing collection of objects that corresponds to this unique string
                ...
                if (disamRow) {
                    ...
                    var compAutocomplete = EDDAutoComplete.createAutoCompleteContainer("measurementcompartment", 4, 'disamMComp' + EDDATD.Disam.autoCompUID, umCompartment, 0);
                    var typeAutocomplete = EDDAutoComplete.createAutoCompleteContainer("metabolite", 45, 'disamMType' + EDDATD.Disam.autoCompUID + 1, umType, 0);
                    var unitsAutocomplete = EDDAutoComplete.createAutoCompleteContainer("units", 15, 'disamMUnits' + EDDATD.Disam.autoCompUID + 2, umUnits, 0);
    ...
    prepareIt: function () {
        ...
        EDDATD.StartData.Metabolites.allTimestamps.sort(function (a, b) {
            return a - b;
        }); // Sort ascending
        EDDATD.StartData.Transcriptions.allTimestamps.sort(function (a, b) {
            return a - b;
        }); // Sort ascending
        EDDATD.StartData.Proteins.allTimestamps.sort(function (a, b) {
            return a - b;
        }); // Sort ascending
...
//# sourceMappingURL=AssayTableDataEdit.js.map