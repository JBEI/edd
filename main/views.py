...
# /study/<study_id>/import/rnaseq/parse-edgepro
def study_import_rnaseq_parse_edgepro (request, study) :
    """
    Parse raw data from an uploaded text file generated by the EDGE-pro
    RNA-seq pipeline, and return JSON object of
    processed result.  Result is identical to study_import_rnaseq_process,
    but this method is invoked by drag-and-drop of a file.
    """
    model = Study.objects.get(pk=study)
