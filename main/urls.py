...
urlpatterns = patterns('',
    ...
    url(r'^study/(?P<study>\d+)/attach/$', login_required(views.study_attach), name='study_attach'),
    url(r'^study/(?P<study>\d+)/comment/$', login_required(views.study_comment), name='study_comment'),
