...
urlpatterns = patterns('',
    ...
    url(r'^study/(?P<study>\d+)/import/rnaseq/parse$', login_required(views.study_import_rnaseq_parse)),
    url(r'^study/(?P<study>\d+)/import/rnaseq/process$', login_required(views.study_import_rnaseq_process)),
    url(r'^study/(?P<study>\d+)/import/rnaseq/edgepro$', login_required(views.study_import_rnaseq_edgepro)),
    ...
    url(r'^study/(?P<study>\d+)/attach$', login_required(views.study_attach)),
    url(r'^admin$', login_required(views.admin_home)),
    url(r'^admin/carbonsources$', login_required(views.admin_carbonsources)),
    url(r'^admin/measurements$', login_required(views.admin_measurements)),
    url(r'^admin/metadata$', login_required(views.admin_metadata)),
    url(r'^admin/strains$', login_required(views.admin_strains)),
